...
3. Layer 0 Blockchain (Cross chain interoperability):
    ...
    3. [What is Cosmos](https://www.youtube.com/watch?v=y4d8XMBVF1A) (21 min video)
        3.1 [Cosmos Complete Begineer's guide](https://www.youtube.com/watch?v=sgIGVsg51W8&ab_channel=CoinBureau) (21 min video)
...
1. Must watch: [Explanation of BIP-39: Wallet Mnemonic words derivation](https://youtu.be/hRXcY_tIlrw) (video) 
2. Must watch: [Explanation of BIP-32: Hierarchical Deterministic Wallet](https://youtu.be/2HrMlVr1QX8) (video) 
...
4. BIP-44: [Hierarchical Deterministic Wallet](https://github.com/bitcoin/bips/blob/master/bip-0044.mediawiki) (github) 
    1. [Keys, Addresses, Wallets explained](https://www.oreilly.com/library/view/mastering-bitcoin/9781491902639/ch04.html#:~:text=A%20bitcoin%20wallet%20contains%20a,a%20public%20key%20(K).) (article)
5. BIP-48: [Multi-sig Wallet](https://github.com/bitcoin/bips/blob/master/bip-0048.mediawiki) (github)
    1. [Multi-signature Wallet, how does it work?](https://www.makeuseof.com/what-are-multi-signature-wallets/#:~:text=A%20multi%2Dsignature%20wallet%20(%22,sign%20documents%20as%20a%20group.) (article)
...
* [What is Web3.0](https://www.youtube.com/watch?v=TV7SHUGTxNU&ab_channel=DappUniversity) (14 min)
...
* [Create a Token (ERC-20)](https://www.youtube.com/watch?v=ZLFiGHIxS1c&t=204s) (22 min)
...
* [How to upgrade a smart contract?](https://www.youtube.com/watch?v=RoXgaAvoIjg) (22 min)
* [How much data can be saved in a smart contract](https://ethereum.stackexchange.com/questions/68712/how-much-data-can-i-store-in-a-smart-contract-what-is-the-cost-and-how-it-is-im#:~:text=The%20contract%20size%20must%20be,really%20use%20all%20this%20memory%3F) (post)
...
* [What is a DEX (Decentralized Exchange)](https://www.youtube.com/watch?v=2tTVJL4bpTU) (7 min)
* [What is a Liquidity pool](https://www.youtube.com/watch?v=cizLhxSKrAc) (10 min video)
* [What are Flash loan](https://www.youtube.com/watch?v=Aw7yvGFtOvI) (18 min)
* [What is a Yearn finance](https://www.youtube.com/watch?v=qG1goOptZ5w) (10 min)
...
1. [What is an oracle?](https://www.youtube.com/watch?v=ZJfkNzyO7-U&ab_channel=Chainlink) (6 min)
...
1. [Kucoin hack, $45M stolen](https://rekt.news/epic-hack-homie/)
1. [Poly Network hack, $611M stolen](https://rekt.news/polynetwork-rekt/)
1. [Ethereum Uniswap V3 LP lower performance than V2 LP](https://rekt.news/uniswap-v3-lp-rekt/)
1. [Solana BadgerDAO, $120M Stolen ](https://www.theblockcrypto.com/post/126072/defi-protocol-badgerdao-exploited-for-120-million-in-front-end-attack)
1. [Bitmart hack, $196M stolen](https://rekt.news/bitmart-rekt/)
1. [Compound hack, $147M stolen](https://rekt.news/compound-rekt/)
1. [Avalanche Snowdog DAO Rekt](https://rekt.news/snowdog-rekt/)
1. [Crypto.COM $33.7M stolen](https://rekt.news/cryptocom-rekt/)
1. [Solana Wormhole $326 stolen](https://rekt.news/wormhole-rekt/)
1. [Solana Cashio infinite minting](https://rekt.news/cashio-rekt/)
1. [Ronin network $624M stolen](https://rekt.news/ronin-rekt/)

## 3. Various articles on the Blockchain/Web3.0 economy

1. [Tokens are a new digital primitive, analogous to the website](https://cdixon.mirror.xyz/0veLm9KKWae4T6_H3siLpKF933NSdC3F75jhPQw_qWE)
2. [What is Olympus Pro (Bond as a service, Liquidity provide)](https://olympusdao.medium.com/introducing-olympus-pro-d8db3052fca5)
